...
<div class="page-header d-print-none">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">Edit Regulation</h2>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Form Edit Regulation</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description"
                                          ...
                                          rows="3">{{ old('description', $regulation->description) }}</textarea>
                                @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <a href="{{ asset($regulation->file_path) }}" target="_blank">
                                    {{ $regulation->title }} ({{ strtoupper($regulation->type) }})
                                </a>
                            </div>
